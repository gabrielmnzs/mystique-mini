...
import * as presetApi from '@gabrielmnzs/mystique-react/preset'
import * as styledSystemApi from '@gabrielmnzs/mystique-react/styled-system'
import * as typegenApi from '@gabrielmnzs/mystique-react/typegen'
...
const tree = React.createElement(
  ...
  components.map((Component, index) => React.createElement(Component, { color: 'accent', key: index }, 'esm')),
)
const markup = renderToString(tree)
if (!markup.includes('esm') || !markup.includes('mystique-')) throw new Error(`unexpected ESM render: ${markup}`)
