import { type ComponentProps, type ComponentRef, createRef } from 'react';
...
const valid = (
  <MystiqueProvider value={customSystem}>
...
const validRecipeButton = (
  <RecipeButton tone={{ base: 'solid', md: 'ghost' }} />
);
const validRecipeProps: RecipeContextProps<'button', undefined> = {
  tone: 'solid',
};
...
const invalidSelectedRef = (
  // @ts-expect-error selected option refs must point to HTMLOptionElement
  <Circle as="option" selected ref={document.createElement('a')} />
);
