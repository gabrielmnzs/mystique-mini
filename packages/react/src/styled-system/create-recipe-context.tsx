...
> = R extends RecipeDefinition
  ? RecipeSelection<R>
  : RecipeTypegenProps<K>
...
>(
  ...
  >(
    ...
    const StyledComponent = React.forwardRef<React.ComponentRef<T>, P>((inputProps, ref) => {
    ...
    StyledComponent.displayName =
      factoryOptions?.displayName ?? contextName
